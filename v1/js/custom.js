...
var subButton = getUrlParameter('b');
...
$(document).ready(function(){
		if (width <= 480) {
			$('.textFix').addClass('.casenotesm');
		} else
			$('.textFix').addClass('.casenotesd');
	});


$('.phone').on('focus click change keyup', function(){
			$('.smallDisclaimer').delay(400).show(0).addClass('animated fadeIn');
