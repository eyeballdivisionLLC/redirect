...
var articleLander = [
  '<div class="contentHolder shadow" id="headingAppended" style="height: 200%;padding: 40px; margin-top: 30px;">',
        '<h2 class="responsive noPadding headingRed logoRed">FDA Warns This Drug Is Linked To Serious And Fatal Health Risks</h2><br>',
        '<p class="logoRed" align="justify"><strong>Attention users of Xarelto -</strong> A specialized Legal Team is Seeking Millions in Settlements For Victims of this Dangerous Drug, Claim your free consultation with an attorney today</p>',
        '<p class="logoRed" align="justify">In 2012 Alone, Xarelto Use Was Associated with 2,081 Serious Adverse Events, Including At Least 151 Deaths.</p>',
        ...
        '<p class="logoRed"><ul class="logoRed betterList text-left"><li><strong>Gastrointestinal Bleeding</strong></li><li>Brain Hemorrhage</li><li><strong>Uncontrollable Internal Bleeding</strong></li><li>  Hemorrhagic Stroke</li><li><strong> Death</strong></li></ul><br>',
        '<p class="logoRed" align="justify">Your time to file may be limited, yet top legal teams are dedicated to helping victims and getting the justice and compensation they deserve...</p><br>',
...
var H1B1lander1 = [
  ...
  '                              <a class="logoRed text-center Continue strong" data-answer="Click the button" data-value="first" href="#">Click the button</a> below to get started today.</p>',
  '                              <br><br><button type="button" class="btn btn-primary btn-footer btn- buttonContinue Continue special" data-answer="button" data-value="first">Get Started ></button>'
...
'<div id="used_xarelto" class="question list-group mainFlow pi" style="display:none"> ',
                              ...
                              '<button type="button" class="btn btn-primary buttonContinue btn-footerRight button2 Continue special" data-answer="1" data-value="used_xarelto">Yes</button>',
                              '<button type="button" class="btn btn-primary buttonContinue testData btn-footerLeft button2 Continue special" data-answer="0" data-value="used_xarelto">No</button><br><br>',
                              '<i>*This is a free service<br> no credit card required.</i><br><br>',
                          '</div>',
